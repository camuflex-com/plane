...
import type { IProjectWebhookStore } from "./webhook.store";
import { ProjectWebhookStore } from "./webhook.store";

export interface IProjectRootStore {
  project: IProjectStore;
  projectFilter: IProjectFilterStore;
  publish: IProjectPublishStore;
  webhook: IProjectWebhookStore;
}
...
export class ProjectRootStore {
  ...
  constructor(_root: CoreRootStore) {
    ...
    this.webhook = new ProjectWebhookStore(_root);
  }
}
